...
function [] = hangmanHard()
%HANGMANHARD generates a hangman game using words from a text file of
%'hard' words

    % get random word
    dictionary = "hangmanDictHard.txt";
    ...
    while (numLives>0)
        ...
        fprintf("Number of guesses made: %d \n ", numGuesses);
